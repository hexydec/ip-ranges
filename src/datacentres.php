...
class datacentres extends generate {
	...
	protected function asnMatches(string $name, int $asn) {
		...
		$asnListUS = [8075 => 'Microsoft Corporation (Azure)', 8100 => 'QuadraNet Enterprises LLC', 8560 => 'IONOS SE', 8569 => 'IONOS SE (sub-services)', 8972 => 'PlusServer GmbH', 14061 => 'DigitalOcean, LLC', 14618 => 'Amazon.com, Inc. (AWS)', 14907 => 'Linode, LLC (Akamai Cloud)', 15169 => 'Google LLC (Google Cloud)', 16509 => 'Amazon.com, Inc. (AWS Primary)', 18450 => 'WebNX, Inc.', 18978 => 'ENZU / Atlantic.Net', 19318 => 'Interserver, Inc.', 19551 => 'Imperva (Incapsula CDN/WAF)', 19994 => 'Rackspace Hosting', 20013 => 'CYRUSONE / LiquidNet Ltd.', 20446 => 'Highwinds Network Group, Inc. (StackPath)', 20473 => 'The Constant Company, LLC (Vultr)', 20476 => 'Psychz Networks', 22611 => 'InMotion Hosting, Inc.', 22612 => 'Namecheap, Inc.', 25847 => 'Choopa, LLC (Vultr)', 26347 => 'New Dream Network, LLC (DreamHost)', 26496 => 'GoDaddy.com, LLC', 29802 => 'HIVELOCITY, Inc.', 29873 => 'Endurance International Group (EIG)', 30058 => 'FDCSERVERS', 30148 => 'Sucuri / GoDaddy', 31216 => 'BSO Network Solutions', 32097 => 'WholeSale Internet, Inc. (NOCIX)', 32181 => 'GigeNET', 32244 => 'Liquid Web, L.L.C', 33182 => 'HostDime.com, Inc.', 33517 => 'Oracle / Dyn', 34282 => 'manitu GmbH', 34432 => 'Profihost AG', 35540 => 'OVH BE', 36351 => 'SoftLayer Technologies, Inc. (IBM Cloud)', 36352 => 'ColoCrossing', 36444 => 'Newfold Digital / HostGator', 396982 => 'Google Cloud (expansion)', 39905 => 'IBM Cloud (expansion)', 40065 => 'CNSERVERS / Atlantic.Net', 40244 => 'Turnkey Internet Inc.', 40367 => 'OVH Hosting, Inc. (Canada/US)', 40676 => 'Psychz Networks', 44066 => 'First Colo GmbH', 46844 => 'Sharktech', 51167 => 'Contabo GmbH', 55293 => 'A2 Hosting, Inc.', 58010 => 'INWX GmbH & Co. KG', 13749 => 'Data Foundry, Inc.', 14618 => 'Amazon AWS (some region-specific)', 15169 => 'Google Cloud (main ASN)', 16276 => 'OVH SAS', 197540 => 'netcup GmbH', 200924 => 'hosting.de GmbH', 202160 => 'Joodle'];
